...
## Category 1 — Coverage smoke (15 cases, one per role × grade)
...
## Category 2 — Situation compatibility (4 cases)
...
## Category 3 — Structural constraints (6 cases)
...
## Category 4 — Vocabulary tier tagging (4 cases)
...
## Category 5 — Phonetic guides (3 cases)
...
## Category 7 — Length boundary (2 cases)
...
## Category 8 — Lexile compliance (3 cases)
